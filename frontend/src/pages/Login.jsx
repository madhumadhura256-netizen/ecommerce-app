    ...
    <div className="auth-page">
      ...
      <style>{`
        ...
        .auth-illustration {
          ...
          margin-top: 60px; max-width: 240px; position: relative; z-index: 1;
        }
        .float-emoji {
          font-size: 2.4rem; animation: floatEmoji 3s ease-in-out infinite alternate;
          display: inline-block;
        }
        @keyframes floatEmoji { from{transform:translateY(0) rotate(-5deg)} to{transform:translateY(-12px) rotate(5deg)} }
        ...
        .auth-title {
          font-family: 'Playfair Display', Georgia, serif;
          font-size: 1.9rem; font-weight: 800; color: var(--text, #111); margin: 0 0 6px;
        }
        ...
        .input-wrap {
          ...
          padding: 0 14px; background: var(--bg, #f9fafb);
        ...
        .input-icon { font-size: 1rem; user-select: none; }
        .auth-input {
          flex: 1; border: none; outline: none; background: transparent;
          padding: 13px 0; font-size: 0.95rem; color: var(--text, #111);
        }
        ...
        .btn-social {
          ...
          padding: 12px; border-radius: 12px; border: 1.5px solid var(--border,#d1d5db);
          background: var(--bg-card,#fff); color: var(--text,#111);
          font-weight: 600; font-size: 0.92rem; cursor: pointer; transition: background 0.2s;
        }
        .btn-social:hover { background: var(--bg-hover,#f3f4f6); }
